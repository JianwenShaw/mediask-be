...
public class ContextBuilder {
     ...
     * 设置医生列表
     */
    public ContextBuilder doctors(List<Doctor> doctors) {
     ...
     * 设置日期范围
     */
    public ContextBuilder dateRange(DateRange dateRange) {
     ...
     * 设置日期范围（天数，从明天开始）
     */
    public ContextBuilder dateRangeDays(int days) {
     ...
     * 设置时间配置
     */
    public ContextBuilder timeConfig(TimeSlotConfig timeConfig) {
     ...
     * 设置求解器
     */
    public ContextBuilder solver(String solverName) {
     ...
     * 配置专家覆盖要求
     */
    public ContextBuilder expertCoverage(boolean require, double minRate) {
